...
const dict: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    todayMessages: "메시지",
    session: "세션",
    "insight.cache_write": "💡 캐시 재생성 많음 — 컨텍스트가 자주 바뀌어요",
    "insight.heavy": "💡 요청당 토큰 많음 — 컨텍스트가 무거워요",
    osNotif: "OS 알림",
  ...
  en: {
    ...
    session: "Session",
    "insight.cache_write": "💡 High cache recreation — context changes often",
    "insight.heavy": "💡 High tokens per request — heavy context",
